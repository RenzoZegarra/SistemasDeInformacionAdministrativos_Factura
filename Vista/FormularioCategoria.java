...
public class FormularioCategoria extends JFrame {
    ...
    public FormularioCategoria(String tipoEntidad) {
    ...
    private void agregarFormulario() {
        ...
        panelForm.add(new JLabel("Nombre de Categoría:"));
    ...
    private void agregarTabla() {
        String[] columnas = {"ID Categoria", "Nombre de Categoría", "Descripción"};
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new FormularioCategoria("Categoria"));
    }
}
